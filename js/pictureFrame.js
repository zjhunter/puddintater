...
function printImg()
{
	document.write("<img src='images/france/" + saImageNames[iActiveImage] + "'>");
}

function printHeader()
{
	document.write(saImageTitles[iActiveImage]);
}

function printTitle()
{
	document.write("<title>Puddintater.com - " + saImageTitles[iActiveImage] + "</title>");
}
